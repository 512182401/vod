...
public class MagicCameraView extends MagicBaseView {
    ...
    public MagicCameraView(Context context, AttributeSet attrs) {
        ...
        LogUtils.sysout("MagicParams.videoPath" + MagicParams.videoPath + "----" + MagicParams.videoName);
        recordingStatus = -1;
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        if (surfaceTexture == null)
            return;
        surfaceTexture.updateTexImage();//获取每一帧的数据
        if (recordingEnabled) {
    ...
    private void openCamera() {
        ...
        LogUtils.w("open12","info.orientation=" + info.orientation + "------------info.isFront=" + info.isFront);
    ...
    private MagicViewListener listener;
    ...
    public void setMagicViewListener(MagicViewListener listener) {
