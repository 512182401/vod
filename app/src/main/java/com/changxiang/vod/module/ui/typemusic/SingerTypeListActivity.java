...
public class SingerTypeListActivity extends BaseActivity implements View.OnClickListener,
...
//        mList = mLocalMusicManager.SingerQuery("刘德华");
        mList = mLocalMusicManager.LangQuery(typeValue,0,100);
...
//                            getSearchBysinsgerData();//根据歌手获取歌曲
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            StatusBarUtil.setColor(SingerTypeListActivity.this, Color.argb(70, 0, 0, 0), 0);
        }
    }
    ...
    private void initEvent() {
        ...
        scrollView.setListener(new ScrollChangeScrollView.IOnScrollListener() {
            ...
            public void onScroll(int tag, int scrollY) {
                ...
                if (tag == 2) {
                    StatusBarUtil.setColor(SingerTypeListActivity.this, Color.argb((int) alpha, 220, 52, 42), 0);
//                    search_top.setBackgroundColor(getResources().getColor(R.color.halfBlack));
                    ...
                    StatusBarUtil.setColor(SingerTypeListActivity.this, Color.rgb(220, 52, 42), 0);
                }
            }
        });
    }
...
//                intent = new Intent(SingerListActivity.this, MusicPlayActivity.class);
                intent = new Intent(SingerTypeListActivity.this, MusicPlayerActivity.class);
    ...
    public void permissionSuccess(int request_code_permission) {
        ...
        switch (request_code_permission) {
            case 0x0002://开启摄像头的权限
                Intent intent = new Intent(SingerTypeListActivity.this, OpenCameraActivity.class);
                Bundle bundle = new Bundle();
