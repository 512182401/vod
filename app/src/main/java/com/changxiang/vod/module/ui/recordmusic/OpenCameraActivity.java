...
import com.changxiang.vod.module.entry.CurrentPeriodBean;
...
import com.changxiang.vod.module.other.HomeListener;
import com.changxiang.vod.module.ui.base.BaseActivity;
import com.changxiang.vod.module.ui.recordmusic.recordutils.Blur;
import com.changxiang.vod.module.ui.recordmusic.recordutils.ExtAudioRecorder;
import com.changxiang.vod.module.ui.recordmusic.recordutils.NoDragSeekBar;
import com.changxiang.vod.module.ui.recordmusic.recordutils.RecorderManager;
import com.changxiang.vod.module.ui.recordmusic.screen.FragmentMusicScreen;
...
//    private int countNum;//倒计时数字
    ...
    private RelativeLayout q7Parent;
    private ImageView q7Image;
...
//                sbEnd.setText("12:00");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //虚拟键
        LogUtils.w("hi","--------" + android.os.Build.BRAND);
        if ("HONOR".equals(android.os.Build.BRAND)){
            setLayoutAgain();
        }
        //关闭第三方app播放
    ...
    private void setLayoutAgain() {
        ...
        mChildOfContent.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                if (bottomRl != null && rl != null) {
                    //可见高和宽
                    Rect r = new Rect();
                    mChildOfContent.getWindowVisibleDisplayFrame(r);
                    usableHeightNow = r.bottom - r.top;//当前可用屏幕高
...
//                    ViewGroup.LayoutParams layoutParams = bottomRl.getLayoutParams();
                    ...
                    if (usableHeightNow != usableHeightPrevious) {
                        LogUtils.w("hi", "usableHeightNow== " + usableHeightNow + "-------------" + "usableHeightPrevious== " + usableHeightPrevious);
                        //虚拟键盘的高度
                        if (usableHeightNow != 0 && usableHeightPrevious != 0 && usableHeightNow > usableHeightPrevious) {
                            LogUtils.w("hi", "111111111111");
                            bordHeight = usableHeightNow - usableHeightPrevious;
//                            layoutParams.height = bottomRl.getHeight() + bordHeight;
                            layoutParams1.height = rl.getHeight() + bordHeight;
                        } else if (usableHeightNow != 0 && usableHeightPrevious != 0 && usableHeightNow <= usableHeightPrevious) {
                            LogUtils.w("hi", "2222222222222");
                            bordHeight = usableHeightPrevious - usableHeightNow;
//                            layoutParams.height = bottomRl.getHeight() - bordHeight;
                            layoutParams1.height = rl.getHeight() - bordHeight;
                        } else {
                            int heightOffset = mChildOfContent.getRootView().getHeight() - mChildOfContent.getHeight();//
                            LogUtils.w("hi", mChildOfContent.getRootView().getHeight() + "---33333333333333----------" + heightOffset);
                            if (heightOffset > 0) {
//                                layoutParams1.height = rl.getHeight() + heightOffset;
                            } else {
                                layoutParams1.height = rl.getHeight() + 128;
                            }
                        }
...
//        }
    ...
    private void initView() {
        ...
        q7Parent = (RelativeLayout) findViewById(R.id.q7_parent_rl);
        q7Image = (ImageView) findViewById(R.id.q7_image);
        //动画
        ...
        bottomRl = (RelativeLayout) findViewById(R.id.open_bottom);
        rl = (RelativeLayout) findViewById(R.id.open_rl1);
        ...
        fragmentState = (ImageView) findViewById(R.id.fragment_state);
...
//        PreferUtil.getInstance().putString("font","small");
    ...
    //麦克风要左右摇晃30度  来回一次  q7Image
    private void startq7Animail() {
//        q7Image.setRotation();
//        ObjectAnimator animator = ObjectAnimator.ofFloat(q7Image,"rotation",0,-30,0,30);
...
//        animator.start();
        ...
        q7Image.startAnimation(rotateAnimation);
    }
...
//            bgImg.setImageBitmap(blurBitmap);
    ...
    private void initEvent() {
        ...
        fragmentState.setOnClickListener(this);
...
//        registerHomeListener();//监控Home键和网络状态
        ...
        fragmentState.setVisibility(View.GONE);
        fragmentText.setVisibility(View.GONE);
        beautyFilter.setVisibility(View.VISIBLE);
        q7Parent.setVisibility(View.VISIBLE);
        //隐藏
    ...
    private void stop() {
        try {
            if ("mv".equals(mFState)) {
                ...
                LogUtils.w("tag12", "-------------1");
                stopAudioRecorder();
//                magicEngine.setFilter(types[0]);
                beautyFilter.onClick(beautyFilter.getOriginConfirm());//重录默认无
            } else if ("mp3".equals(mFState)) {
                LogUtils.w("tag12", "-------------2");
                stopAudioRecorder();
            }
...
//            hideOrShowMusicScreen(true);//隐藏音乐屏
    ...
    public void onCompletion(MediaPlayer mp) {
        ...
        stop();
        //视频拼接
        intent = new Intent(OpenCameraActivity.this, SavePracticeActivity.class);
        endRecordTime = total;
        parameterPass(getFinalVideoFileName(), recordAudioPath, startRecordTime, endRecordTime);
...
//                                intent = new Intent(OpenCameraActivity.this, PracticeSongActivity.class);
    ...
    private void startBtn() {
        if (download.getProgress() == 100) {
            ...
            beautyFilter.setVisibility(View.INVISIBLE);
            q7Parent.setVisibility(View.GONE);
            //显示
