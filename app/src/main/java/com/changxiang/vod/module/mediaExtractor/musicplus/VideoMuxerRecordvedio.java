 ...
 * @author Darcy
 */
public abstract class VideoMuxerRecordvedio {

    private static final String TAG = "VideoMuxer";

    String mOutputVideo;

    private VideoMuxerRecordvedio(String outputVideo) {
        this.mOutputVideo = outputVideo;
    }

    public final static VideoMuxerRecordvedio createVideoMuxer(String outputVideo) {//合成的文件路i经
...
//
     ...
     * @version API >= 18
     */
    private static class Mp4Muxer extends VideoMuxerRecordvedio {
