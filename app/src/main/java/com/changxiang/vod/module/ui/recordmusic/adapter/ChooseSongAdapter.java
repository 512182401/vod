...
//    public List<CurrentPeriodBean> beanList = new ArrayList<>();
...
//
//    public ChooseSongAdapter(List<CurrentPeriodBean> beanList, Context context, boolean deleteState) {
...
//        SongHolder holder;
//        if (convertView == null) {
//            convertView = inflater.inflate(R.layout.adapter_mychoose_song, null);
//            holder = new SongHolder(convertView);
//            convertView.setTag(holder);
//        }
//        holder = (SongHolder) convertView.getTag();
//        CurrentPeriodBean item = beanList.get(position);
//        songName = item.getSongName();
//        singerName = item.getSingerName();
//        String imgHead = item.getId();
//        songId = item.getId();
//        musicType = item.getType();
//        size = item.getSize();
//        if (size != null && !size.equals("") && !size.equals("0")) {
//            holder.sizeTv.setText("" + Formatter.formatFileSize(context, Integer.parseInt(size) * 1024));//后台给单位KB
//        } else {
...
//            if (arrCheck.get(position)) {
//                holder.deleteCb.setChecked(arrCheck.get(position));
//                LogUtils.w("ListUtils", arrCheck.get(position) + "");
//            } else {
//                holder.deleteCb.setChecked(arrCheck.get(position));
//            }
//        } else {
...
//                @Override
//                public void onClick(View v) {
//                    if (onItemPKListener != null){
//                        onItemPKListener.onItemPK(selectedPosition, arrDownload.get(selectedPosition),beanList.get(selectedPosition));
//                    }
//                }
//            });
//
...
//            holder.deleteCb.setClickable(false);
...
//    }
//
//    public void addDataList(List<CurrentPeriodBean> songList) {
//        if (songList != null) {
//            for (int i = 0; i < songList.size(); i++) {
//                hotSong = beanList.get(i);
//                if (DownloadAllService.isWaiting(hotSong.getId(), hotSong.getType())) {
...
//
//    //获取list数据
//    public List<CurrentPeriodBean> getBeanList() {
//        return beanList;
//    }
//
//    //设置checkbox的状态
...
//
//    //接口回调
//    public interface onItemPKListener {
//        void onItemPK(int position, boolean isDownload, CurrentPeriodBean currentPeriodBean);
//    }
//
//    private onItemPKListener onItemPKListener;
//
//    public void setOnItemPKListener(onItemPKListener onItemPKListener) {
//        this.onItemPKListener = onItemPKListener;
//    }
//}
