...
import com.changxiang.vod.BuildConfig;
...
public class Constant {
    ...
    // 与 DEFAULT_CHANNEL_CONFIG 相关，因为是mono单声，所以是1
    ...
    //SurfaceView尺寸  宽 /  高
    public static final int previewRateW = 3 ;
    public static final int previewRateH = 4 ;
}