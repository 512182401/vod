package com.changxiang.vod.module.ui.agora;
...
public class VideoChatViewActivity extends AppCompatActivity {
    private NearPerson.ResultsBean mpersonal = null;
    private int uid = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            mpersonal = (NearPerson.ResultsBean) getIntent().getExtras().getSerializable("nearperson");
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void joinChannel() {
        try {
            if (mpersonal != null && !mpersonal.equals("")) {
                uid = Integer.parseInt(mpersonal.getId());
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
