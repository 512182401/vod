...
import com.changxiang.vod.module.ui.topmusic.ISetProgress;
...
public class TypeMusicReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        }else if ("TYPE_ACTION_FINISH".equals(intent.getAction())){
            if (iSetProgress!=null){
                iSetProgress.setFinishImg(position,songId,musicType);
            }
        }else if ("TYPE_ACTION_EXCEPTION".equals(intent.getAction())){
            if (iSetProgress!=null){
