...
public class SKrcViewFour extends ScrollView implements OnTouchListener, ILrcStateContain {
    ...
    public SKrcViewFour(Context context) {
        this(context, null);
        // TODO Auto-generated constructor stub
    }

    public SKrcViewFour(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        // TODO Auto-generated constructor stub
    }

    public SKrcViewFour(Context context, AttributeSet attrs, int defStyle) {
...
//                        float currentX = DisplayUtil.dip2px(mContext, 100);
                        if (i == index) {
//                            LogUtils.w("test","1111111111111111");
                            // 获得字符串的"长度"
...
//                            LogUtils.w("test","2222222222222222");
//                            currentX = DisplayUtil.dip2px(mContext, 100);
...
//                            canvas.drawText(lrcLists.get(i).getLineStr().replaceAll("\\s", " ").trim(),currentX * 2, tempY, linePaint);
                            ...
                            //跑马灯
//                            LogUtils.w("test","333333333333333");
//                            currentX = DisplayUtil.dip2px(mContext, 100);
