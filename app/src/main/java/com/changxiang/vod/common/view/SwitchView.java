...
//		paint.setColor(isOn ? 0xffFF5F5F : 0xff5F5E5E);
//		// paint.setColor(isOn ? 0xffff0000 : 0xffe6e6e6);
...
//		if (isOn) {
//			LogUtils.log("denisty", getResources().getDisplayMetrics().density
//					+ "");
//			canvas.translate(mDensity, -shadowHeight);
//		} else {
...
//		paint.setStrokeWidth(bStrokeWidth * 0.6f);
//
//		paint.setColor(0xFF5F5E5E);
//		canvas.drawPath(bPath, paint);
//
//		canvas.restore();
//
...
//			isOpened = false;
//		} else if (!isOpened && newState == STATE_SWITCH_OFF2) {
//			isOpened = false;
//		} else if (isOpened && newState == STATE_SWITCH_ON2) {
//			isOpened = true;
//		}
//		lastState = state;
//		state = newState;
