...
//    private int DEFAULT_HEIGHT_DP = 30;
//
...
//        try {
//            textSize = (int) ta.getDimension(R.styleable.FlikerProgressBar_textSize1, 12);
//            loadingColor = ta.getColor(R.styleable.FlikerProgressBar_loadingColor, Color.parseColor("#40c4ff"));
////            loadingColor = ta.getColor(R.styleable.FlikerProgressBar_loadingColor, Color.parseColor("#00ffffff"));
//            stopColor = ta.getColor(R.styleable.FlikerProgressBar_stopColor, Color.parseColor("#ff9800"));
//            startColor = ta.getColor(R.styleable.FlikerProgressBar_stopColor, Color.parseColor("#00ffffff"));
...
//                height = DensityUtil.dip2px(getContext(),DEFAULT_HEIGHT_DP);
//                break;
...
//        } else {
//            progressColor = loadingColor;
////            progressColor = startColor;//搜索界面第二次修改
//            thread = new Thread(this);
//            thread.start();
//        }
//        invalidate();
...
//        int width = 0;
//        try {
//            width = flikerBitmap.getWidth();
//        }catch (Exception e){
//            e.printStackTrace();
//        }
//        try {
//            while (!isStop && !thread.isInterrupted()){
//                flickerLeft += DensityUtil.dip2px(getContext(),5);
//                float progressWidth = (progress / maxProgress) * getMeasuredWidth();
...
//            }
//        } else{
//            text = getResources().getString(R.string.sing);
//        }
//
//        return text;
//    }
