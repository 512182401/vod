...
//
//public class CameraLrcView extends ScrollView implements OnScrollChangedListener, OnTouchListener, ILrcStateContain {
...
//    private MediaPlayer mediaPlayer;//练歌页面的播放器
//    private int PlayerType;//0表示听歌页面的播放器，1表示练歌页面播放器
//
//    //private OnLrcSearchClickListener onLrcSearchClickListener;
//
//    public CameraLrcView(Context context) {
//        this(context, null);
//        // TODO Auto-generated constructor stub
//    }
//
//    public CameraLrcView(Context context, AttributeSet attrs) {
//        this(context, attrs, 0);
//        // TODO Auto-generated constructor stub
//    }
//
//    public CameraLrcView(Context context, AttributeSet attrs, int defStyle) {
...
//
//            int tempY = (int) height / 2;//歌词的起点
//            //int tempY = (int) height-DisplayUtil.dip2px(mContext, 24); ;
//            //int tempY = DisplayUtil.dip2px(mContext, 25);//歌词的起点
//
//            switch (lrcState) {
//                case READ_LOC_FAIL:
...
//
//                            //canvas.drawText(lrcLists.get(i).getLrcStr(), width / 2, height, currentPaint);
//                        } else if (i == pos) {
...
//                        }
//                        LogUtils.w("height","歌词："+lrcLists.get(i).getLrcStr());
//                        LogUtils.w("height","歌词位置："+tempY);
//                    }
//                    break;
...
//        lightTextSize = DisplayUtil.sp2px(mContext, 22);
...
//
//        @Override
//        public void handleMessage(BqMessage msg) {
//            // TODO Auto-generated method stub
//
