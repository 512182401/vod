...
//
//public class SKrcViewSix extends ScrollView implements OnTouchListener, ILrcStateContain {
...
//
//    public SKrcViewSix(Context context) {
//        this(context, null);
//        // TODO Auto-generated constructor stub
//    }
//
//    public SKrcViewSix(Context context, AttributeSet attrs) {
//        this(context, attrs, 0);
//        // TODO Auto-generated constructor stub
//    }
//
//    public SKrcViewSix(Context context, AttributeSet attrs, int defStyle) {
...
//                            //歌词跑马灯
//                            if (lrcLists.size() != 0){
//                                startCurrentMarquee(canvas, currentX * 2, lrcLists.get(i).getLineStr().replaceAll("\\s", " ").trim(), currentPaint);
//                            }
//
//                        } else if (i == pos) {
////                            currentX = DisplayUtil.dip2px(mContext, 100);
...
//                        a, f, Shader.TileMode.CLAMP);
//                currentPaint.setShader(shader);
//                canvas.drawText(currentLrc, DisplayUtil.dip2px(mContext, 100) * 2, tempY, currentPaint);
//            }
//        }
//
...
//    }
//
//    IClickListner listener;
//    public interface IClickListner{
//        void doAnimal();
//    }
//    public void setClickListener(IClickListner listener) {
