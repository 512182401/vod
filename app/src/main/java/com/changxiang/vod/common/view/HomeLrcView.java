...
//
//public class HomeLrcView extends ScrollView implements OnScrollChangedListener, OnTouchListener, ILrcStateContain {
...
//    }
//
//    public HomeLrcView(Context context, AttributeSet attrs) {
//        this(context, attrs, 0);
//        // TODO Auto-generated constructor stub
//    }
//
//    public HomeLrcView(Context context, AttributeSet attrs, int defStyle) {
...
//            int tempY = (int) height-DisplayUtil.dip2px(mContext, 10); ;//歌词的起点
//
//            switch (lrcState) {
//                case READ_LOC_FAIL:
