...
//     * 保存个人设置信息
//     */
//    public void cacheApiPersonSet(PersonSetPK json) {
//        synchronized (lock) {
////            mShpr.edit().putString( PersonSet_Object, json ).commit();
//            setObject(PersonSet_Object, json);
//        }
//    }
//
//    public PersonSetPK getCacheApiPersonSet() {
//        synchronized (lock) {
////            return mShpr.get( PersonSet_Object, "" );
//            return getObject(PersonSet_Object, PersonSetPK.class);
//        }
//    }
//
//    /**
//     * 保存新手引导信息
//     */
//    public void cacheApiguide(GuideItem json) {
//        synchronized (lock) {
////            mShpr.edit().putString( PersonSet_Object, json ).commit();
//            setObject(GUIDE_Object, json);
//        }
//    }
//
//    public GuideItem getCacheApiguide() {
//        synchronized (lock) {
////            return mShpr.get( PersonSet_Object, "" );
//            return getObject(GUIDE_Object, GuideItem.class);
//        }
//    }
//
//    /**
