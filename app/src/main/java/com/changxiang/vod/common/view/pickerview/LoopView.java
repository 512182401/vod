package com.changxiang.vod.common.view.pickerview;
...
//        colorBlack = 0xff313131;
    ...
    private void d() {
        ...
        e();//获取宽高 g，h。
        t = (int) ((float) h * l * (float) (r - 1));//h*2*8
...
//                        canvas.drawText( as[j1], startX, h, paintA );
    ...
    public boolean onTouchEvent(MotionEvent motionevent) {
        this.getParent().requestDisallowInterceptTouchEvent( true );////屏蔽父控件拦截onTouch事件
        switch (motionevent.getAction()) {
            case MotionEvent.ACTION_DOWN:
                x = motionevent.getRawY();
                move1 = motionevent.getRawY();
            ...
            case MotionEvent.ACTION_UP:
                move2 = motionevent.getRawY();

                if (Math.abs(move2-move1)>20) {
                    break;
                }
//                break;
            default:
